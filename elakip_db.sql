...
--
-- Host: localhost
-- Generation Time: Jan 18, 2023 at 06:04 AM
...
ALTER TABLE `kegiatan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `id_misi` (`id_misi`,`id_tujuan`),
  ADD KEY `id_tujuan` (`id_tujuan`);
...
--
-- Constraints for table `indikator_target`
--
ALTER TABLE `indikator_target`
  ADD CONSTRAINT `indikator_target_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `indikator_target_ibfk_2` FOREIGN KEY (`id_tujuan`) REFERENCES `tujuan` (`id`);

--
-- Constraints for table `kegiatan`
--
ALTER TABLE `kegiatan`
  ADD CONSTRAINT `kegiatan_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `kegiatan_ibfk_2` FOREIGN KEY (`id_misi`) REFERENCES `misi` (`id`),
  ADD CONSTRAINT `kegiatan_ibfk_3` FOREIGN KEY (`id_tujuan`) REFERENCES `tujuan` (`id`);
...
--
ALTER TABLE `misi`
  ADD CONSTRAINT `misi_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `tujuan`
--
ALTER TABLE `tujuan`
  ADD CONSTRAINT `tujuan_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `tujuan_ibfk_2` FOREIGN KEY (`id_misi`) REFERENCES `misi` (`id`);

--
-- Constraints for table `visi`
--
ALTER TABLE `visi`
  ADD CONSTRAINT `visi_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
COMMIT;
